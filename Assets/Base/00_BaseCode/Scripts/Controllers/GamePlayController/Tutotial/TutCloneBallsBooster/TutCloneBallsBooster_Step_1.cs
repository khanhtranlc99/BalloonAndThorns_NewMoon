...
public class TutCloneBallsBooster_Step_1 : TutorialBase
{
    ...
    public override void StartTut()
    {
        if (UseProfile.CurrentLevel == 7)
        {
            ...
            currentHand.transform.parent = GamePlayController.Instance.playerContain.cloneBallsBooster.cloneBallsBooster_Btn.transform;
    ...
    Vector3 post
    {
        get
        {
            return GamePlayController.Instance.playerContain.cloneBallsBooster.cloneBallsBooster_Btn.transform.position;
        }
    }
