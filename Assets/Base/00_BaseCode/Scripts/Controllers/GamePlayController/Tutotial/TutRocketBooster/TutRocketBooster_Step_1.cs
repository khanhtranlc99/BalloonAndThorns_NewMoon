...
public class TutRocketBooster_Step_1 : TutorialBase
{
    ...
    public override void StartTut()
    {
        if (UseProfile.CurrentLevel == 9)
        {
            ...
            currentHand.transform.parent = GamePlayController.Instance.playerContain.roketBooster.RoketBooster_Btn.transform;
    ...
    Vector3 post
    {
        get
        {
            return GamePlayController.Instance.playerContain.roketBooster.RoketBooster_Btn.transform.position;
        }
    }
